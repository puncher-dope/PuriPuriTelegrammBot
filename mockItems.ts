...
export const cardsForWaiter = [
  {
    ...
    comment:
      "Розовая матча-это 100% натуральная сублимированная пудра питахайи родом из Коста-Рики",
    description:
      "Нежный напиток, сочетающий в себе терпкость розовой матчи и легкую сладость сиропа бабл гам.",
  },
  {
    id: 2,
    name: "Бабл-гам матча",
...
export const cardsForBartender = [
  {
    id:1,
